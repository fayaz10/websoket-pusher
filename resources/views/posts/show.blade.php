...
@section('content')
  <div class="container">
    ...
    <div style="margin-bottom:50px;" v-if="user">
      <textarea class="form-control" rows="3" name="body" v-model='commentBox' placeholder="Leave a comment"></textarea>

      <button class="btn btn-success" style="margin-top:10px" @click.prevent="postComment">Save Comment</button>
    </div>
    <div v-else>
      <h4>you must login to submit comment </h4>
      <a href="/login">Log i  &gt;&gt;</a>
    </div>
